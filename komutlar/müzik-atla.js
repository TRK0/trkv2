...
.setDescription(`<a:flushed:750076071721828452>  **| Oynatılan bir müziği geçebilmek için bir ses kanalında olmanız gerekmektedir!**`)
...
.setTitle("TRK | Atla")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<a:track_next:750076071721828452>  **|** \`${sarki.name}\` **adlı müzik** ${message.author} **tarafından geçildi!**`) 
