...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:tools:750076071721828452> **Bu komutu kullanabilmek için** "\`Yönetici\`" **yetkisine sahip olmalısın.**`);
 ...
 if(!rol) return message.reply(`<a:tools:750076071721828452>  **Bu özellik zaten kapalı! :wink: **`)
 
 
  message.channel.send(`<a:thumbsup:750076071721828452>  **Sayaç başarılı bir şekilde kapatıldı.**`)
