  ...
  if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:x:750076071721828452>  **Bu komutu kullanabilmek için "\`Yönetici\`" yetkisine sahip olmalısın.**`);
