...
exports.run = async (bot, msg, args) => {
        ...
        .replace("dnd", `<:red_circle:749747908756111420>  | **Rahatsız Etmeyin**`)
        .replace("online", `<:green_circle:749747908466966580>  | **Çevrimiçi**`)
        .replace("idle", `<:last_quarter_moon_with_face:749747908529619105>  | **Boşta**`)
        .replace("offline", `<:black_circle:749748262717882389>  | **Çevrimdışı**`)
        ...
        .setFooter(`TRK Bot | Kullanıcı Bilgi Sistemi`)
